...
average_flight_rating <- airline %>%
  group_by(Country) %>%
  summarize(average_flight_rating = mean(, na.rm = TRUE)) %>%
  arrange(desc(average_flight_rating))


best_country_for_flights <- average_flight_rating$Country[1]

best_country_for_flight
