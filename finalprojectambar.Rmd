...
ggplot(top_destinations, aes(x = reorder(Route, -Count), y = Count, fill = Type_of_Travellers)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(
    title = "Top Destinations for Each Type of Traveler",
    x = "Destination",
    y = "Number of Flights",
...
Bulgaria, Chile, Costa Rica, Luxembourg, Panama, Senegal, Ukraine, and  Brazil  have the customer service and chances are you arent in a Boeing plane, the first class is better, but the upgrade from Premium Economy is worth it for better service, unfortunately i the best value for you money isn't in the best place to have great customer service and is probably not recommended that you fly. But if you have a family you probably travel just as much as couples. ans most people tend to go to Cape town  for a couples gateway.
